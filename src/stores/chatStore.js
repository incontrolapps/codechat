...
export const setUserdata = async (username, timestamp) => {
  localStorage.setItem('codechatUsername', username)
  localStorage.setItem('codechatTimestamp', timestamp)
}

// Retrieve user data from localstorage
export const loadUserdata = async () => {
  if (typeof localStorage != undefined) {
    let tempUser = localStorage.getItem('codechatUsername')
    let tempDate = localStorage.getItem('codechatTimestamp')
